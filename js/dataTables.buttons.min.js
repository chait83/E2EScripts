...
(function (d) {
  ...
  l.buttonSelector = function (a, b) {
    for (var c = [
      ...
      for (var d, g, f = 0, h = b.length; f < h; f++) if (d = b[f]) g = c !== m ? c + f : f + '',
      a.push({
        node: d.node,
        name: d.conf.name,
        idx: g
  ...
  d.extend(j, {
    ...
    add: function (a, b) {
    	...
    	if (j.pdfHtml5 && j.pdfHtml5.available(a, b)) return 'AddHtml5';
    	if (j.pdfFlash && j.pdfFlash.available(a, b)) return 'pdfFlash'
    },
