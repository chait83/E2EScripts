(function (g) {
	'function' === typeof define && define.amd ? define(['jquery',
		'datatables.net',
		'datatables.net-buttons'], function (i) {
		...
		var w = h.document.createElementNS('http://www.w3.org/1999/xhtml', 'a'),
			...
			J = function (a, b, d) {
				...
				if (O) e = (h.URL || h.webkitURL || h).createObjectURL(a),
					...
					if ('application/octet-stream' === d || z)
						g = h;
	...
	var x = function (a, b) {
		...
		L = function (a, b) {
			for (var d = K(b), c = a.buttons.exportData(b.exportOptions), f = b.fieldBoundary, e = b.fieldSeparator, g = RegExp(f, 'g'), l = b.escapeChar !== o ? b.escapeChar : '\\', h = function (a) {
				for (var b = '', c = 0, d = a.length; c < d; c++) 0 < c && (b += e),
	...
	r.ext.buttons.copyHtml5 = {
		className: 'dt-new-button buttons-html5',
		text: function (a) {
			return a.i18n('buttons.copy', '<span class="fas fa-paste" style="font-size:20px !important"></span>')
		},
	...
	r.ext.buttons.csvHtml5 = {
		...
		text: function (a) {
			return a.i18n('buttons.csv', '<span class="fas fa-file-csv" style="font-size:20px !important"></span>')
		},
		action: function (a, b, d, c) {
			a = L(b, c).str;
			b = c.charset;
		...
		escapeChar: '"',
		charset: null,
		titleAttr: "Download CSV format",
		header: !0,
		footer: !1
	};
	r.ext.buttons.AddHtml5 = {
		bom: !1,
		...
		text: function (a) {
			return a.i18n('Add new feature', '<span class="fas fa-plus-circle" style="font-size:20px"></span>')
		},
		action: function (a, b, d, c) {
			execAdd();
		},
	...
	r.ext.buttons.excelHtml5 = {
		...
		text: function (a) {
			return a.i18n('buttons.excel', '<span class="far fa-file-excel" style="font-size:20px"></span>')
		},
		titleAttr: "Download as Excel sheet",
		action: function (a, b, d, c) {
			var f = 0,
				a = function (a) {
				...
				d = function (a) {
					...
					for (var b = 0, c = a.length; b < c; b++) {
						for (var d = b, i = ''; 0 <= d;) i = String.fromCharCode(d % 26 + 65) + i,
							d = Math.floor(d / 26) - 1;
						d = i + '' + l;
						if (null === a[b] || a[b] === o)
							a[b] = '';
	...
	r.ext.buttons.pdfHtml5 = {
		...
		text: function (a) {
			return a.i18n('buttons.pdf', '<span class="far fa-file-pdf" style="font-size:20px"></span>')
		},
